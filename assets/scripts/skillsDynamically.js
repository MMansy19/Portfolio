...
const skillsArray = [
  ...
  { name: "REST API", experience: "2023", stars: 4, type: "backend" },
...
const generateListItem = (skillItem) => {
  ...
  return `<li class="skills__item" data-type=${skillItem.type} data-name=${skillItem.name
    }>
    <h2 class="skills__title">${skillItem.name}</h2>
    <span class="skills__stars">${starsHtml}</span>
    <br/><span class="skills__years">${currentYear - skillItem.experience
    } years</span>
  </li>`;
};
